...
4. Foi criado um dataframe com os primeiros colocados das temporadas para observar qual era a média e desvio padrão da variável alvo para que uma equipe conquistasse essa colocação.
...
* O R² alto e MSE baixo indicam previsões mais estáveis entre seasons, podendo ser valiosos para metas operacionais.
(imagem)
